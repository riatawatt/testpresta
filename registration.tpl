...
{block name='head'}
      ...
      <style>
        body#authentication .modal-content {
          padding: 1.25rem;
          padding-top: 1.25rem;
...
{block name='page_content'}
    {block name='register_form_container'}
      ...
      <section class="register-form">
        ...
        {assign var="isRegisterForm" value="true"}
        {render file='customer/_partials/customer-form.tpl' ui=$register_form isRegisterForm=$isRegisterForm}
      </section>
        ...
        jQuery(function (){
          jQuery.ajax({
            ...
            success : function (resultHtml) {   
              ...
              jQuery('#content').html(resultHtml);
