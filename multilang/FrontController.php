...
class FrontControllerCore extends Controller
{
    ...
    public function init()
    {
        ...
        // var_dump($this->context->link->getPageLink($this->php_self, $this->ssl, $this->context->language->id), $this->context->language->id);die;    
    ...
    protected function smartyOutputContent($content)
    {
        ...
        $domainUrl = $this->getDomainUrlBySubDomain();
        $html = str_replace('www.ps17.com',  $domainUrl, $html);
        // $html = strtr($html, array('www.ps17.com' => $domainUrl));
        echo trim($html);
    }

    public function getDomainUrlBySubDomain () {
        $exploded_domain = explode('.', $_SERVER['HTTP_HOST']);
        $subdomain = (!empty($exploded_domain)) ? $exploded_domain[0] : 'www';
        $domain = 'www.ps17.com';
