...
class LinkCore
{
    ...
    public function getPageLink($controller, $ssl = null, $idLang = null, $request = null, $requestUrlEncode = false, $idShop = null, $relativeProtocol = false)
    {
        ...
        var_dump($this->getBaseLink($idShop, $ssl, $relativeProtocol))  ;die;
    ...
    { 
        $idShop = $this->getIdShopByDomain ();
        $id_lang = $this->getLanguageIdBySubDomain ();
        ...
        if (Configuration::get('PS_MULTISHOP_FEATURE_ACTIVE') && $idShop !== null) {
            $shop = new Shop($idShop, $id_lang, $idShop, false);
        } else {
            $shop = Context::getContext()->shop;die('icisqdfqs');
        }
    ...
    public function getIdShopByDomain () { 
